...
`,St="https://images.godsunchained.com";r(4);var Ct=function(e,t,r,n){var i,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,n);else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(s=(o<3?i(s):o>3?i(t,r,s):i(t,r))||s);return o>3&&s&&Object.defineProperty(t,r,s),s},kt=function(e,t,r,n){return new(r||(r=Promise))((function(i,o){function s(e){try{l(n.next(e))}catch(e){o(e)}}function a(e){try{l(n.throw(e))}catch(e){o(e)}}function l(e){var t;e.done?i(e.value):(t=e.value,t instanceof r?t:new r((function(e){e(t)}))).then(s,a)}l((n=n.apply(e,t||[])).next())}))};const Tt=["plain","plain","bronze","iron","meteorite","shadow","gold","diamond"],Pt=["diamond","gold","shadow","meteorite","plain"],zt=new He(e=>{e.forEach(e=>{e.target.handleResize(e)})});let Et=class extends oe{constructor(){super(),this.quality=5,this.useLegacyQualityMapping=!1,this.useLegacyComposition=!0,this.compositionCardData={type:"",effect:"",name:"",rarity:"",god:"",set:"",mana:"",id:"",attack:null,health:null,tribe:"",art_id:"",composition:{illustration:[],frame:[],rosette:[],gems:[],wreath:[],lock:[],tribe_bar:[]}},this.loading=!0,this.quality=0,this.ch=.01*this.offsetHeight,this.cw=.01*this.offsetWidth}static get styles(){return rt()}connectedCallback(){super.connectedCallback(),zt.observe(this)}disconnectedCallback(){super.disconnectedCallback(),zt.unobserve(this)}updated(e){e.forEach((e,t)=>{"protoId"===t?this.getProtoDataFromApi():"inputProtoData"!==t&&"inputCompositionData"!==t||this.getProtoDataFromInput(t)})}handleResize(e){const t=e.target.shadowRoot.children[0];this.ch=.01*t.offsetHeight,this.cw=.01*t.offsetWidth,this.requestUpdate()}fetchProtoData(){return kt(this,void 0,void 0,(function*(){return this.loading=!0,fetch(`https://api.godsunchained.com/v0/composition?pairs=${this.protoId}@${this.quality}`).then(e=>e.json())}))}getProtoDataFromApi(){return kt(this,void 0,void 0,(function*(){return this.fetchProtoData().then(e=>{if(e.error)return null;const{id:t,type:r,attack:n,health:i,effect:o,name:s,rarity:a,god:l,mana:c,set:p,tribe:d,art_id:u,composition:h}=e[0];return this.compositionCardData={id:t,type:r,attack:n.Int64,health:i.Int64,effect:o,name:s,rarity:a,god:l,mana:c,set:p,tribe:d.String,art_id:u,composition:h},this.loading=!1,this.requestUpdate(),e})}))}getProtoDataFromInput(e){this.compositionCardData="inputProtoData"==e?Object.assign({},this.inputProtoData):Object.assign({},this.inputCompositionData),this.compositionCardData.composition||this.useLegacyComposition||(this.useLegacyComposition=!0),this.loading=!1,this.requestUpdate()}render(){if(this.useLegacyComposition){const e=this.useLegacyQualityMapping?Tt[this.quality]:Pt[this.quality-1],t="mythic"===this.compositionCardData.rarity;return I`
  ...
  `})({ch:this.ch,cw:this.cw,...this.compositionCardData,cardSet:this.compositionCardData.composition.set})}
      ...
      `}};Ct([Z({type:Number})],Et.prototype,"protoId",void 0),Ct([Z({type:Number})],Et.prototype,"quality",void 0),Ct([Z({type:Object})],Et.prototype,"inputProtoData",void 0),Ct([Z({type:Object})],Et.prototype,"inputCompositionData",void 0),Ct([Z({type:String})],Et.prototype,"responsiveSrcsetSizes",void 0),Ct([Z({type:Boolean})],Et.prototype,"useLegacyQualityMapping",void 0),Ct([Z({type:Boolean})],Et.prototype,"useLegacyComposition",void 0),Et=Ct([Y("composited-card")],Et);const Nt=ne`
  font-family: 'Unchained', serif;
  line-height: 1.1;
`,Lt=ne`
  font-family: 'Open Sans', sans-serif;
  line-height: 1.5;
`,Ot=ne`black`,qt=ne`white`,Rt=ne`#f9f9f9`,Mt=(ne`#f1f1f1`,ne`65px`),At=ne`100px`,jt=ne`#282828`,Dt=ne`#333`,It=ne`rgba(255,255,255,0.15)`,Ut=[ne`#8295A2`,ne`#8295A2`,ne`#6A8B35`,ne`#3D91B9`,ne`#84343E`,ne`#B461C5`,ne`#E5D93C`,ne`#94E6FB`,ne`white`],Bt=ne`#9f78dd`,Vt=(e=0)=>ne`
  width: 100%;
  cursor: pointer;
  background: ${jt};
  border: 2px solid ${It};
...
//# sourceMappingURL=bundle.70d767e5d5c80061c08c.js.map