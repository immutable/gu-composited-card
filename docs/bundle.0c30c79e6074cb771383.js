 ...
 */const n=new WeakMap,i=e=>(...t)=>{const r=e(...t);return n.set(r,!0),r},o=e=>"function"==typeof e&&n.has(e),s=void 0!==window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,a=(e,t,r=null)=>{for(;t!==r;){const r=t.nextSibling;e.removeChild(t),t=r}},l={},c={},p=`{{lit-${String(Math.random()).slice(2)}}}`,d=`\x3c!--${p}--\x3e`,u=new RegExp(`${p}|${d}`),h="$lit$";class _{constructor(e,t){this.parts=[],this.element=t;const r=[],n=[],i=document.createTreeWalker(t.content,133,null,!1);let o=0,s=-1,a=0;const{strings:l,values:{length:c}}=e;for(;a<c;){const e=i.nextNode();if(null!==e){if(s++,1===e.nodeType){if(e.hasAttributes()){const t=e.attributes,{length:r}=t;let n=0;for(let e=0;e<r;e++)$(t[e].name,h)&&n++;for(;n-- >0;){const t=l[a],r=y.exec(t)[2],n=r.toLowerCase()+h,i=e.getAttribute(n);e.removeAttribute(n);const o=i.split(u);this.parts.push({type:"attribute",index:s,name:r,strings:o}),a+=o.length-1}}"TEMPLATE"===e.tagName&&(n.push(e),i.currentNode=e.content)}else if(3===e.nodeType){const t=e.data;if(t.indexOf(p)>=0){const n=e.parentNode,i=t.split(u),o=i.length-1;for(let t=0;t<o;t++){let r,o=i[t];if(""===o)r=f();else{const e=y.exec(o);null!==e&&$(e[2],h)&&(o=o.slice(0,e.index)+e[1]+e[2].slice(0,-h.length)+e[3]),r=document.createTextNode(o)}n.insertBefore(r,e),this.parts.push({type:"node",index:++s})}""===i[o]?(n.insertBefore(f(),e),r.push(e)):e.data=i[o],a+=o}}else if(8===e.nodeType)if(e.data===p){const t=e.parentNode;null!==e.previousSibling&&s!==o||(s++,t.insertBefore(f(),e)),o=s,this.parts.push({type:"node",index:s}),null===e.nextSibling?e.data="":(r.push(e),s--),a++}else{let t=-1;for(;-1!==(t=e.data.indexOf(p,t+1));)this.parts.push({type:"node",index:-1}),a++}}else i.currentNode=n.pop()}for(const e of r)e.parentNode.removeChild(e)}}const $=(e,t)=>{const r=e.length-t.length;return r>=0&&e.slice(r)===t},g=e=>-1!==e.index,f=()=>document.createComment(""),y=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class m{constructor(e,t,r){this.__parts=[],this.template=e,this.processor=t,this.options=r}update(e){let t=0;for(const r of this.__parts)void 0!==r&&r.setValue(e[t]),t++;for(const e of this.__parts)void 0!==e&&e.commit()}_clone(){const e=s?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),t=[],r=this.template.parts,n=document.createTreeWalker(e,133,null,!1);let i,o=0,a=0,l=n.nextNode();for(;o<r.length;)if(i=r[o],g(i)){for(;a<i.index;)a++,"TEMPLATE"===l.nodeName&&(t.push(l),n.currentNode=l.content),null===(l=n.nextNode())&&(n.currentNode=t.pop(),l=n.nextNode());if("node"===i.type){const e=this.processor.handleTextExpression(this.options);e.insertAfterNode(l.previousSibling),this.__parts.push(e)}else this.__parts.push(...this.processor.handleAttributeExpressions(l,i.name,i.strings,this.options));o++}else this.__parts.push(void 0),o++;return s&&(document.adoptNode(e),customElements.upgrade(e)),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const b=` ${p} `;class w{constructor(e,t,r,n){this.strings=e,this.values=t,this.type=r,this.processor=n}getHTML(){const e=this.strings.length-1;let t="",r=!1;for(let n=0;n<e;n++){const e=this.strings[n],i=e.lastIndexOf("\x3c!--");r=(i>-1||r)&&-1===e.indexOf("--\x3e",i+1);const o=y.exec(e);t+=null===o?e+(r?b:d):e.substr(0,o.index)+o[1]+o[2]+h+o[3]+p}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const M=(e,...t)=>new w(e,t,"html",q),I=133;function j(e,t){const{element:{content:r},parts:n}=e,i=document.createTreeWalker(r,I,null,!1);let o=D(n),s=n[o],a=-1,l=0;const c=[];let p=null;for(;i.nextNode();){a++;const e=i.currentNode;for(e.previousSibling===p&&(p=null),t.has(e)&&(c.push(e),null===p&&(p=e)),null!==p&&l++;void 0!==s&&s.index===a;)s.index=null!==p?-1:s.index-l,o=D(n,o),s=n[o]}c.forEach(e=>e.parentNode.removeChild(e))}const V=e=>{let t=11===e.nodeType?0:1;const r=document.createTreeWalker(e,I,null,!1);for(;r.nextNode();)t++;return t},D=(e,t=-1)=>{for(let r=t+1;r<e.length;r++){const t=e[r];if(g(t))return r}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
`)():M`
    ...
    <picture class="card__artwork">
      <source
        srcset="
          ...
          ${Nt}/art2/${$t}/${e}.webp ${_t}w,
          ${Nt}/art2/${gt}/${e}.webp ${$t}w,
          ${Nt}/art2/${ft}/${e}.webp ${gt}w,
          ${Nt}/art2/${yt}/${e}.webp ${ft}w,
          ${Nt}/art2/${mt}/${e}.webp ${yt}w,
          ${Nt}/art2/${bt}/${e}.webp ${mt}w
        "
        sizes="${t}"
        type="image/webp"
      />
      <source
        srcset="
          ...
          ${Nt}/art2/${$t}/${e}.jpg ${_t}w,
          ${Nt}/art2/${gt}/${e}.jpg ${$t}w,
          ${Nt}/art2/${ft}/${e}.jpg ${gt}w,
          ${Nt}/art2/${yt}/${e}.jpg ${ft}w,
          ${Nt}/art2/${mt}/${e}.jpg ${yt}w,
          ${Nt}/art2/${bt}/${e}.jpg ${mt}w
        "
        sizes="${t}"
        type="image/jpg"
      />
  ...
  `)({id:this.protoCardData.id,responsiveSrcsetSizes:this.responsiveSrcsetSizes})}
              ${t?(({responsiveSrcsetSizes:e=`${vt}px`,art_id:t,type:r})=>M`
    <picture class="card__baseLayer">
      ...
      <img
        srcset="${Nt}/border-layers/types/${r}/${wt}/${r}_${t}.png"
    ...
    <picture class="card__manaLayer">
      <source
        srcset="
          ${Nt}/border-layers/types/${r}/${vt}/mythic_${t}.webp ${wt}w,
          ${Nt}/border-layers/types/${r}/${xt}/mythic_${t}.webp ${vt}w,
          ${Nt}/border-layers/types/${r}/${St}/mythic_${t}.webp ${xt}w,
          ${Nt}/border-layers/types/${r}/${Ct}/mythic_${t}.webp ${St}w,
          ${Nt}/border-layers/types/${r}/${kt}/mythic_${t}.webp ${Ct}w,
          ${Nt}/border-layers/types/${r}/${Pt}/mythic_${t}.webp ${kt}w
        "
        sizes="${e}"
        type="image/webp"
      />
      <source
        srcset="
          ${Nt}/border-layers/types/${r}/${vt}/mythic_${t}.png ${wt}w,
          ${Nt}/border-layers/types/${r}/${xt}/mythic_${t}.png ${vt}w,
          ${Nt}/border-layers/types/${r}/${St}/mythic_${t}.png ${xt}w,
          ${Nt}/border-layers/types/${r}/${Ct}/mythic_${t}.png ${St}w,
          ${Nt}/border-layers/types/${r}/${kt}/mythic_${t}.png ${Ct}w,
          ${Nt}/border-layers/types/${r}/${Pt}/mythic_${t}.png ${kt}w
        "
        sizes="${e}"
        type="image/png"
      />
      ...
      <img
        srcset="${Nt}/border-layers/types/${r}/${vt}/mythic_${t}.png"
        class="card__manaLayer__img card__manaLayer__img--mythic"
      />
    </picture>
  `)({responsiveSrcsetSizes:this.responsiveSrcsetSizes,art_id:this.protoCardData.art_id,type:this.protoCardData.type}):(({responsiveSrcsetSizes:e=`${vt}px`,type:t,qualityName:r,rarity:n,god:i,set:o,tribe:s})=>(t=zt(t),M`
    <picture class="card__baseLayer">
      <source
        srcset="
    ...
    ${s?M`
          <picture class="card__tribeBarLayer">
            <source
              srcset="
                ${Nt}/border-layers/layers/${vt}/tribebar_${r}.webp ${vt}w,
                ${Nt}/border-layers/layers/${xt}/tribebar_${r}.webp ${xt}w,
                ${Nt}/border-layers/layers/${St}/tribebar_${r}.webp ${St}w,
                ${Nt}/border-layers/layers/${Ct}/tribebar_${r}.webp ${Ct}w,
                ${Nt}/border-layers/layers/${kt}/tribebar_${r}.webp ${kt}w,
                ${Nt}/border-layers/layers/${Pt}/tribebar_${r}.webp ${Pt}w
              "
              sizes="${e}"
              type="image/webp"
            />
            <source
              srcset="
                ${Nt}/border-layers/layers/${vt}/tribebar_${r}.png ${vt}w,
                ${Nt}/border-layers/layers/${xt}/tribebar_${r}.png ${xt}w,
                ${Nt}/border-layers/layers/${St}/tribebar_${r}.png ${St}w,
                ${Nt}/border-layers/layers/${Ct}/tribebar_${r}.png ${Ct}w,
                ${Nt}/border-layers/layers/${kt}/tribebar_${r}.png ${kt}w,
                ${Nt}/border-layers/layers/${Pt}/tribebar_${r}.png ${Pt}w
              "
              sizes="${e}"
              type="image/png"
            />
            ...
            <img
              srcset="
                ${Nt}/border-layers/layers/${Pt}/tribebar_${n}.png
              "
  ...
  `))(Object.assign({qualityName:e,responsiveSrcsetSizes:this.responsiveSrcsetSizes},this.protoCardData))}
              ${(({type:e="",name:t="⃠",effect:r="⃠",mana:n="⃠",attack:i="⃠",health:o="⃠",tribe:s="",cardSet:a="",ch:l=0,cw:c=0})=>{e=zt(e);const p=RegExp(/creature|weapon/).test(e),d=t.split("").length>=20,u=Math.floor(.5*l),h=`${0===u?1:u}px`,_="rgba(0, 0, 0, 1)",$=`0 0 ${h} ${_}, 0 0 ${h} ${_}, 0 0 ${h} ${_}`,g=tt({fontSize:`${10.5*l}px`,top:`${6.85*l}px`,left:`${9.5*c}px`,width:`${19*c}px`,textShadow:$}),f=tt({fontSize:`${d?3.9*l:4.93*l}px`,bottom:`${32.85*l}px`,height:`${9*l}px`,left:`${13.25*c}px`,right:`${5.3*c}px`,textShadow:$}),y=tt({fontSize:`${9.5*l}px`,bottom:`${4.5*l}px`,width:`${15*c}px`,left:`${10.5*c}px`,textShadow:$}),m=tt({fontSize:`${9.5*l}px`,width:`${16*c}px`,bottom:`${4.6*l}px`,right:`${2.5*c}px`,textShadow:$}),b=tt({fontSize:`${3.2*l}px`,bottom:`${3.1*l}px`,height:`${4.82*l}px`,left:`${30.5*c}px`,right:`${23*c}px`,textShadow:$}),w=tt({fontSize:`${6*l}px`,top:`${10*l}px`,right:`${9*c}px`});return M`
  ...
  `})(Object.assign({ch:this.ch,cw:this.cw},this.protoCardData,{cardSet:this.protoCardData.set}))}
    ...
    `}};Ot([le({type:Number})],Mt.prototype,"protoId",void 0),Ot([le({type:Number})],Mt.prototype,"quality",void 0),Ot([le({type:Object})],Mt.prototype,"inputProtoData",void 0),Ot([le({type:String})],Mt.prototype,"responsiveSrcsetSizes",void 0),Ot([le({type:Boolean})],Mt.prototype,"useLegacyQualityMapping",void 0),Mt=Ot([oe("composited-card")],Mt);const It=ue`
  font-family: 'Unchained', serif;
  line-height: 1.1;
`,jt=ue`
  font-family: 'Open Sans', sans-serif;
...
//# sourceMappingURL=bundle.0c30c79e6074cb771383.js.map