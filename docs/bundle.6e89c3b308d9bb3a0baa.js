 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,t,r,n){const i=t[0];if("."===i){return new O(e,t.slice(1),r).parts}return"@"===i?[new A(e,t.slice(1),n.eventContext)]:"?"===i?[new N(e,t.slice(1),r)]:new E(e,t,r).parts}handleTextExpression(e){return new z(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const de={};class ue extends re{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const e=this.getStyles();if(void 0===e)this._styles=[];else if(Array.isArray(e)){const t=(e,r)=>e.reduceRight((e,r)=>Array.isArray(r)?t(r,e):(e.add(r),e),r),r=t(e,new Set),n=[];r.forEach(e=>n.unshift(e)),this._styles=n}else this._styles=[e]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?ae?this.renderRoot.adoptedStyleSheets=e.map(e=>e.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(e=>e.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){const t=this.render();super.update(e),t!==de&&this.constructor.render(t,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(e=>{const t=document.createElement("style");t.textContent=e.cssText,this.renderRoot.appendChild(t)}))}render(){return de}}ue.finalized=!0,ue.render=(e,t,r)=>{if(!r||"object"!=typeof r||!r.scopeName)throw new Error("The `scopeName` option is required.");const n=r.scopeName,o=I.has(t),s=B&&11===t.nodeType&&!!t.host,a=s&&!H.has(n),l=a?document.createDocumentFragment():t;if(((e,t,r)=>{let n=I.get(t);void 0===n&&(i(t,t.firstChild),I.set(t,n=new z(Object.assign({templateFactory:M},r))),n.appendInto(t)),n.setValue(e),n.commit()})(e,l,Object.assign({templateFactory:W(n)},r)),a){const e=I.get(l);I.delete(l);const r=e.value instanceof x?e.value.template:void 0;Q(n,l,r),i(t,t.firstChild),t.appendChild(l),I.set(t,e)}!o&&s&&window.ShadyCSS.styleElement(t.host)};var he,_e,ge=function(e){return Object.defineProperty(e,"toString",{value:function(){return"function ResizeObserver () { [polyfill code] }"}}),e},me="undefined"==typeof window?{}:window,$e=me.requestAnimationFrame,fe={attributes:!0,characterData:!0,childList:!0,subtree:!0},ye=["resize","load","transitionend","animationend","animationstart","animationiteration","keyup","keydown","mouseup","mousedown","mouseover","mouseout","blur","focus"],be=new Map,we=new Map,ve=function(){he||(he=!0,$e((function(e){he=!1;var t=[],r=[];be.forEach((function(e){return t.push(e)})),we.forEach((function(e){return r.push(e)})),be.clear(),we.clear();try{for(var n=0,i=t;n<i.length;n++){(0,i[n])(e)}}finally{for(var o=0,s=r;o<s.length;o++){(0,s[o])(e)}}})))},xe=new(function(){function e(){var e=this;this.stopped=!0,this.listener=function(){return e.schedule()}}return e.prototype.run=function(e){var t=this;we.set(this,(function(){var r=!1;try{r=Xe()}finally{r?t.run(60):e?t.run(e-1):t.start()}})),ve()},e.prototype.schedule=function(){this.stop(),this.run(12)},e.prototype.observe=function(){var e=this,t=function(){return e.observer&&e.observer.observe(document.body,fe)};document.body?t():me.addEventListener("DOMContentLoaded",t)},e.prototype.start=function(){var e=this;this.stopped&&(this.stopped=!1,"MutationObserver"in me&&(this.observer=new MutationObserver(this.listener),this.observe()),ye.forEach((function(t){return me.addEventListener(t,e.listener,!0)})))},e.prototype.stop=function(){var e=this;this.stopped||(this.observer&&this.observer.disconnect(),ye.forEach((function(t){return me.removeEventListener(t,e.listener,!0)})),this.stopped=!0)},e}()),Se=0;me.requestAnimationFrame=function(e){if("function"!=typeof e)throw new Error("requestAnimationFrame expects 1 callback argument of type function.");var t=Se+=1;return be.set(t,(function(t){return e(t)})),ve(),t},me.cancelAnimationFrame=function(e){be.delete(e)},ge(me.requestAnimationFrame),ge(me.cancelAnimationFrame),function(e){e.BORDER_BOX="border-box",e.CONTENT_BOX="content-box"}(_e||(_e={}));var Ce=function(){function e(e,t,r,n){return this.x=e,this.y=t,this.width=r,this.height=n,this.top=this.y,this.left=this.x,this.bottom=this.top+this.height,this.right=this.left+this.width,Object.freeze(this)}return e.fromRect=function(t){return new e(t.x,t.y,t.width,t.height)},e}(),ke=function(e){return e instanceof SVGElement&&"getBBox"in e},Pe=function(e){if(ke(e)){var t=e.getBBox(),r=t.width,n=t.height;return!r&&!n}var i=e,o=i.offsetWidth,s=i.offsetHeight;return!(o||s||e.getClientRects().length)},Ee=new Map,Te=/auto|scroll/,ze=/^tb|vertical/,Ne=/msie|trident/i.test(me.navigator&&me.navigator.userAgent),Oe=function(e){return parseFloat(e||"0")},qe=function(e,t,r){return void 0===e&&(e=0),void 0===t&&(t=0),void 0===r&&(r=!1),Object.freeze({inlineSize:(r?t:e)||0,blockSize:(r?e:t)||0})},Re=Object.freeze({borderBoxSize:qe(),contentBoxSize:qe(),contentRect:new Ce(0,0,0,0)}),Ae=function(e){if(Ee.has(e))return Ee.get(e);if(Pe(e))return Ee.set(e,Re),Re;var t=getComputedStyle(e),r=ke(e)&&e.getBBox(),n=!Ne&&"border-box"===t.boxSizing,i=ze.test(t.writingMode||""),o=!r&&Te.test(t.overflowY||""),s=!r&&Te.test(t.overflowX||""),a=r?0:Oe(t.paddingTop),l=r?0:Oe(t.paddingRight),c=r?0:Oe(t.paddingBottom),p=r?0:Oe(t.paddingLeft),d=r?0:Oe(t.borderTopWidth),u=r?0:Oe(t.borderRightWidth),h=r?0:Oe(t.borderBottomWidth),_=p+l,g=a+c,m=(r?0:Oe(t.borderLeftWidth))+u,$=d+h,f=s?e.offsetHeight-$-e.clientHeight:0,y=o?e.offsetWidth-m-e.clientWidth:0,b=n?_+m:0,w=n?g+$:0,v=r?r.width:Oe(t.width)-b-y,x=r?r.height:Oe(t.height)-w-f,S=v+_+y+m,C=x+g+f+$,k=Object.freeze({borderBoxSize:qe(S,C,i),contentBoxSize:qe(v,x,i),contentRect:new Ce(p,a,v,x)});return Ee.set(e,k),k},Le=function(e,t){var r=Ae(e),n=r.borderBoxSize,i=r.contentBoxSize;return t===_e.BORDER_BOX?n:i},Me=function(){function e(e,t){this.target=e,this.observedBox=t||_e.CONTENT_BOX,this.lastReportedSize={inlineSize:0,blockSize:0}}return e.prototype.isActive=function(){var e,t=Le(this.target,this.observedBox);return e=this.target,ke(e)||function(e){switch(e.tagName){case"INPUT":if("image"!==e.type)break;case"VIDEO":case"AUDIO":case"EMBED":case"OBJECT":case"CANVAS":case"IFRAME":case"IMG":return!0}return!1}(e)||"inline"!==getComputedStyle(e).display||(this.lastReportedSize=t),this.lastReportedSize.inlineSize!==t.inlineSize||this.lastReportedSize.blockSize!==t.blockSize},e}(),je=function(e,t){this.activeTargets=[],this.skippedTargets=[],this.observationTargets=[],this.observer=e,this.callback=t},Ie="ResizeObserver loop completed with undelivered notifications.",Ue=function(e){var t=Ae(e);this.target=e,this.contentRect=t.contentRect,this.borderBoxSize=t.borderBoxSize,this.contentBoxSize=t.contentBoxSize},Ve=function(e){if(Pe(e))return 1/0;for(var t=0,r=e.parentNode;r;)t+=1,r=r.parentNode;return t},De=function(){var e=1/0,t=[];We.forEach((function(r){if(0!==r.activeTargets.length){var n=[];r.activeTargets.forEach((function(t){var r=new Ue(t.target),i=Ve(t.target);n.push(r),t.lastReportedSize=Le(t.target,t.observedBox),i<e&&(e=i)})),t.push((function(){r.callback.call(r.observer,n,r.observer)})),r.activeTargets.splice(0,r.activeTargets.length)}}));for(var r=0,n=t;r<n.length;r++){(0,n[r])()}return e},Be=function(e){Ee.clear(),We.forEach((function(t){t.activeTargets.splice(0,t.activeTargets.length),t.skippedTargets.splice(0,t.skippedTargets.length),t.observationTargets.forEach((function(r){r.isActive()&&(Ve(r.target)>e?t.activeTargets.push(r):t.skippedTargets.push(r))}))}))},We=[],Fe=new Map,He=0,Qe=function(e){!He&&e>0&&xe.start(),!(He+=e)&&xe.stop()},Je=function(e,t){for(var r=0;r<e.length;r+=1)if(e[r].target===t)return r;return-1},Xe=function(){var e,t=0;for(Be(t);We.some((function(e){return e.activeTargets.length>0}));)t=De(),Be(t);return We.some((function(e){return e.skippedTargets.length>0}))&&("function"==typeof ErrorEvent?e=new ErrorEvent("error",{message:Ie}):((e=document.createEvent("Event")).initEvent("error",!1,!1),e.message=Ie),window.dispatchEvent(e)),t>0},Ge=function(){function e(){}return e.connect=function(e,t){var r=new je(e,t);We.push(r),Fe.set(e,r)},e.observe=function(e,t,r){if(Fe.has(e)){var n=Fe.get(e);Je(n.observationTargets,t)<0&&(n.observationTargets.push(new Me(t,r&&r.box)),Qe(1),xe.schedule())}},e.unobserve=function(e,t){if(Fe.has(e)){var r=Fe.get(e),n=Je(r.observationTargets,t);n>=0&&(r.observationTargets.splice(n,1),Qe(-1))}},e.disconnect=function(e){if(Fe.has(e)){var t=Fe.get(e);We.splice(We.indexOf(t),1),Fe.delete(e),Qe(-t.observationTargets.length)}},e}(),Ye=function(){function e(e){if(0===arguments.length)throw new TypeError("Failed to construct 'ResizeObserver': 1 argument required, but only 0 present.");if("function"!=typeof e)throw new TypeError("Failed to construct 'ResizeObserver': The callback provided as parameter 1 is not a function.");Ge.connect(this,e)}return e.prototype.observe=function(e,t){if(0===arguments.length)throw new TypeError("Failed to execute 'observe' on 'ResizeObserver': 1 argument required, but only 0 present.");if(e instanceof Element==!1)throw new TypeError("Failed to execute 'observe' on 'ResizeObserver': parameter 1 is not of type 'Element");Ge.observe(this,e,t)},e.prototype.unobserve=function(e){if(0===arguments.length)throw new TypeError("Failed to execute 'unobserve' on 'ResizeObserver': 1 argument required, but only 0 present.");if(e instanceof Element==!1)throw new TypeError("Failed to execute 'unobserve' on 'ResizeObserver': parameter 1 is not of type 'Element");Ge.unobserve(this,e)},e.prototype.disconnect=function(){Ge.disconnect(this)},e.toString=function(){return"function ResizeObserver () { [polyfill code] }"},e}();
/**
 * @license
 * Copyright (c) 2018 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const Ke=new WeakMap,Ze=y(e=>t=>{if(!(t instanceof T)||t instanceof q||"style"!==t.committer.name||t.committer.parts.length>1)throw new Error("The `styleMap` directive must be used in the style attribute and must be the only part in the attribute.");const{committer:r}=t,{style:n}=r.element;let i=Ke.get(t);void 0===i&&(n.cssText=r.strings.join(" "),Ke.set(t,i=new Set)),i.forEach(t=>{t in e||(i.delete(t),-1===t.indexOf("-")?n[t]=null:n.removeProperty(t))});for(const t in e)i.add(t),-1===t.indexOf("-")?n[t]=e[t]:n.setProperty(t,e[t])});customElements.define("card-icon",class extends ue{constructor(){super(...arguments),this.iconLigature="",this.fillGradientTarget="top"}static get properties(){return{iconLigature:{type:String},fillColor:{type:String},fillGradient:{type:String},fillGradientTarget:{type:String}}}static get styles(){return pe`
      :host {
        display: inline-flex;
      }
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const et=new WeakMap,tt=y(e=>t=>{if(!(t instanceof z))throw new Error("unsafeHTML can only be used in text bindings");const r=et.get(t);if(void 0!==r&&k(e)&&e===r.value&&t.value===r.fragment)return;const n=document.createElement("template");n.innerHTML=e;const i=document.importNode(n.content,!0);t.setValue(i),et.set(t,{value:e,fragment:i})}),rt=pe`
  font-family: 'Unchained', serif;
  line-height: 1.1;
`,nt=pe`
  font-family: 'Open Sans', sans-serif;
`,it=pe`white`,ot=(pe`black`,pe`rgb(51, 51, 51)`),st=pe`#f9f9f9`,at=(pe`#f1f1f1`,pe`
  ${rt}
  font-weight: 700;
  line-height: 0.8;
  text-align: center;
...
`;var ct=function(e,t,r,n){var i,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,n);else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(s=(o<3?i(s):o>3?i(t,r,s):i(t,r))||s);return o>3&&s&&Object.defineProperty(t,r,s),s};let pt=class extends ue{static get styles(){return pe`
      :host {
        position: absolute;
        text-align: center;
        color: black;
    ...
    `}updated(e){}render(){const{text:e,ch:t,cw:r,tribe:n,type:i}=this,o=e.replace(/ ([^ ]*)$/,"&nbsp;$1"),s=e.split("").length;let a=3.8*t,l=1.25,c="normal";return s>=150?(a=2.8*t,l=1.1,c="extraSquishy"):s>=90&&(a=3.4*t,l=1.1,c="squishy"),V`
      <style>
        :host {
          font-size: ${a}px;
          line-height: ${l};
    ...
    `}};ct([se({type:String})],pt.prototype,"text",void 0),ct([se({type:String})],pt.prototype,"tribe",void 0),ct([se({type:String})],pt.prototype,"type",void 0),ct([se({type:Number})],pt.prototype,"ch",void 0),ct([se({type:Number})],pt.prototype,"cw",void 0),pt=ct([ne("autofit-description-text")],pt);const dt=250,ut=375,ht=500,_t=720,gt=1024,mt=1280,$t=1440,ft=1920,yt=256,bt=512,wt=720,vt=1024,xt=1280,St=1440,Ct=1920,kt=256,Pt=512;function Et(e){return"god power"===e?"power":e}const Tt="https://images.godsunchained.com";r(4);var zt=function(e,t,r,n){var i,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,n);else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(s=(o<3?i(s):o>3?i(t,r,s):i(t,r))||s);return o>3&&s&&Object.defineProperty(t,r,s),s},Nt=function(e,t,r,n){return new(r||(r=Promise))((function(i,o){function s(e){try{l(n.next(e))}catch(e){o(e)}}function a(e){try{l(n.throw(e))}catch(e){o(e)}}function l(e){e.done?i(e.value):new r((function(t){t(e.value)})).then(s,a)}l((n=n.apply(e,t||[])).next())}))};const Ot=["plain","plain","bronze","iron","meteorite","shadow","gold","diamond"],qt=["diamond","gold","shadow","meteorite","plain"],Rt=new Ye(e=>{e.forEach(e=>{e.target.handleResize(e)})});let At=class extends ue{constructor(){super(),this.quality=5,this.useLegacyQualityMapping=!1,this.protoCardData={type:"",effect:"",name:"",rarity:"",god:"",set:"",mana:"",id:"",attack:null,health:null,tribe:"",art_id:""},this.loading=!0,this.quality=0,this.ch=.01*this.offsetHeight,this.cw=.01*this.offsetWidth}static get styles(){return lt()}connectedCallback(){super.connectedCallback(),Rt.observe(this)}disconnectedCallback(){super.disconnectedCallback(),Rt.unobserve(this)}updated(e){e.forEach((e,t)=>{"protoId"===t?this.getProtoDataFromApi():"inputProtoData"===t&&this.getProtoDataFromInput()})}handleResize(e){const t=e.target.shadowRoot.children[0];this.ch=.01*t.offsetHeight,this.cw=.01*t.offsetWidth,this.requestUpdate()}fetchProtoData(){return Nt(this,void 0,void 0,(function*(){return this.loading=!0,fetch(`https://api.godsunchained.com/v0/proto/${this.protoId}`).then(e=>e.json())}))}getProtoDataFromApi(){return Nt(this,void 0,void 0,(function*(){return this.fetchProtoData().then(e=>{const{id:t,type:r,attack:n,health:i,effect:o,name:s,rarity:a,god:l,mana:c,set:p,tribe:d,art_id:u}=e;return this.protoCardData={id:t,type:r,attack:n.Int64,health:i.Int64,effect:o,name:s,rarity:a,god:l,mana:c,set:p,tribe:d.String,art_id:u},this.loading=!1,this.requestUpdate(),e})}))}getProtoDataFromInput(){this.protoCardData=Object.assign({},this.inputProtoData),this.loading=!1,this.requestUpdate()}render(){const e=this.useLegacyQualityMapping?Ot[this.quality]:qt[this.quality-1],t="mythic"===this.protoCardData.rarity;return V`
...
`)():V`
              ${(({id:e,responsiveSrcsetSizes:t=`${ut}px`})=>V`
    <picture class="card__artwork">
      <source
        srcset="
          ${Tt}/art2/${ut}/${e}.webp ${dt}w,
          ${Tt}/art2/${ht}/${e}.webp ${ut}w,
          ${Tt}/art2/${_t}/${e}.webp ${ht}w,
          ${Tt}/art2/${gt}/${e}.webp ${_t}w,
          ${Tt}/art2/${mt}/${e}.webp ${gt}w,
          ${Tt}/art2/${$t}/${e}.webp ${mt}w,
          ${Tt}/art2/${ft}/${e}.webp ${$t}w
        "
        sizes="${t}"
        type="image/webp"
      />
      <source
        srcset="
          ${Tt}/art2/${ut}/${e}.jpg ${dt}w,
          ${Tt}/art2/${ht}/${e}.jpg ${ut}w,
          ${Tt}/art2/${_t}/${e}.jpg ${ht}w,
          ${Tt}/art2/${gt}/${e}.jpg ${_t}w,
          ${Tt}/art2/${mt}/${e}.jpg ${gt}w,
          ${Tt}/art2/${$t}/${e}.jpg ${mt}w,
          ${Tt}/art2/${ft}/${e}.jpg ${$t}w
        "
        sizes="${t}"
        type="image/jpg"
      />
      <img
        srcset="${Tt}/art2/${dt}/${e}.jpg"
        class="card__artwork__img"
      />
    </picture>
  `)({id:this.protoCardData.id,responsiveSrcsetSizes:this.responsiveSrcsetSizes})}
              ${t?(({responsiveSrcsetSizes:e=`${bt}px`,art_id:t,type:r,god:n})=>V`
    <picture class="card__baseLayer">
      <source
        srcset="
          ${Tt}/border-layers/types/${r}/${bt}/${r}_${t}.webp ${yt}w,
          ${Tt}/border-layers/types/${r}/${wt}/${r}_${t}.webp ${bt}w,
          ${Tt}/border-layers/types/${r}/${vt}/${r}_${t}.webp ${wt}w,
          ${Tt}/border-layers/types/${r}/${xt}/${r}_${t}.webp ${vt}w,
          ${Tt}/border-layers/types/${r}/${St}/${r}_${t}.webp ${xt}w,
          ${Tt}/border-layers/types/${r}/${Ct}/${r}_${t}.webp ${St}w
        "
        sizes="${e}"
        type="image/webp"
      />
      <source
        srcset="
          ${Tt}/border-layers/types/${r}/${bt}/${r}_${t}.png ${yt}w,
          ${Tt}/border-layers/types/${r}/${wt}/${r}_${t}.png ${bt}w,
          ${Tt}/border-layers/types/${r}/${vt}/${r}_${t}.png ${wt}w,
          ${Tt}/border-layers/types/${r}/${xt}/${r}_${t}.png ${vt}w,
          ${Tt}/border-layers/types/${r}/${St}/${r}_${t}.png ${xt}w,
          ${Tt}/border-layers/types/${r}/${Ct}/${r}_${t}.png ${St}w
        "
        sizes="${e}"
        type="image/png"
      />
      ...
      <img
        srcset="
          ${Tt}/border-layers/types/${r}/${yt}/${r}_${t}.png
        "
    ...
    <picture class="card__manaLayer">
      <source
        srcset="
          ${Tt}/border-layers/rosettes/mythics/${bt}/mythic_${t}.webp ${yt}w,
          ${Tt}/border-layers/rosettes/mythics/${wt}/mythic_${t}.webp ${bt}w,
          ${Tt}/border-layers/rosettes/mythics/${vt}/mythic_${t}.webp ${wt}w,
          ${Tt}/border-layers/rosettes/mythics/${xt}/mythic_${t}.webp ${vt}w,
          ${Tt}/border-layers/rosettes/mythics/${St}/mythic_${t}.webp ${xt}w,
          ${Tt}/border-layers/rosettes/mythics/${Ct}/mythic_${t}.webp ${St}w
        "
        sizes="${e}"
        type="image/webp"
      />
      <source
        srcset="
          ${Tt}/border-layers/rosettes/mythics/${bt}/mythic_${t}.png ${yt}w,
          ${Tt}/border-layers/rosettes/mythics/${wt}/mythic_${t}.png ${bt}w,
          ${Tt}/border-layers/rosettes/mythics/${vt}/mythic_${t}.png ${wt}w,
          ${Tt}/border-layers/rosettes/mythics/${xt}/mythic_${t}.png ${vt}w,
          ${Tt}/border-layers/rosettes/mythics/${St}/mythic_${t}.png ${xt}w,
          ${Tt}/border-layers/rosettes/mythics/${Ct}/mythic_${t}.png ${St}w
        "
        sizes="${e}"
        type="image/png"
      />
      ...
      <img
        srcset="
          ${Tt}/border-layers/rosettes/${n}/${bt}/mythic_${t}.png
        "
        class="card__manaLayer__img card__manaLayer__img--mythic"
      />
    </picture>
  `)(Object.assign({responsiveSrcsetSizes:this.responsiveSrcsetSizes},this.protoCardData)):(({responsiveSrcsetSizes:e=`${bt}px`,type:t,qualityName:r,rarity:n,god:i,set:o,tribe:s})=>(t=Et(t),V`
    <picture class="card__baseLayer">
      <source
        srcset="
          ${Tt}/border-layers/types/${t}/${bt}/${t}_${r}.webp ${yt}w,
          ${Tt}/border-layers/types/${t}/${wt}/${t}_${r}.webp ${bt}w,
          ${Tt}/border-layers/types/${t}/${vt}/${t}_${r}.webp ${wt}w,
          ${Tt}/border-layers/types/${t}/${xt}/${t}_${r}.webp ${vt}w,
          ${Tt}/border-layers/types/${t}/${St}/${t}_${r}.webp ${xt}w,
          ${Tt}/border-layers/types/${t}/${Ct}/${t}_${r}.webp ${St}w
        "
        sizes="${e}"
        type="image/webp"
      />
      ...
      <source
        srcset="
          ${Tt}/border-layers/types/${t}/${bt}/${t}_${r}.png ${yt}w,
          ${Tt}/border-layers/types/${t}/${wt}/${t}_${r}.png ${bt}w,
          ${Tt}/border-layers/types/${t}/${vt}/${t}_${r}.png ${wt}w,
          ${Tt}/border-layers/types/${t}/${xt}/${t}_${r}.png ${vt}w,
          ${Tt}/border-layers/types/${t}/${St}/${t}_${r}.png ${xt}w,
          ${Tt}/border-layers/types/${t}/${Ct}/${t}_${r}.png ${St}w
        "
        sizes="${e}"
        type="image/png"
      />
      <img
        srcset="
          ${Tt}/border-layers/types/${t}/${yt}/${t}_${r}.png
        "
        class="card__baseLayer__img"
      />
    </picture>
    ...
    <picture class="card__manaLayer">
      <source
        srcset="
          ${Tt}/border-layers/rosettes/${i}/${bt}/${i}_${r}.webp ${yt}w,
          ${Tt}/border-layers/rosettes/${i}/${wt}/${i}_${r}.webp ${bt}w,
          ${Tt}/border-layers/rosettes/${i}/${vt}/${i}_${r}.webp ${wt}w,
          ${Tt}/border-layers/rosettes/${i}/${xt}/${i}_${r}.webp ${vt}w,
          ${Tt}/border-layers/rosettes/${i}/${St}/${i}_${r}.webp ${xt}w,
          ${Tt}/border-layers/rosettes/${i}/${Ct}/${i}_${r}.webp ${St}w
        "
        sizes="${e}"
        type="image/webp"
      />
      <source
        srcset="
          ${Tt}/border-layers/rosettes/${i}/${bt}/${i}_${r}.png ${yt}w,
          ${Tt}/border-layers/rosettes/${i}/${wt}/${i}_${r}.png ${bt}w,
          ${Tt}/border-layers/rosettes/${i}/${vt}/${i}_${r}.png ${wt}w,
          ${Tt}/border-layers/rosettes/${i}/${xt}/${i}_${r}.png ${vt}w,
          ${Tt}/border-layers/rosettes/${i}/${St}/${i}_${r}.png ${xt}w,
          ${Tt}/border-layers/rosettes/${i}/${Ct}/${i}_${r}.png ${St}w
        "
        sizes="${e}"
        type="image/png"
      />
      <img
        srcset="
          ${Tt}/border-layers/rosettes/${i}/${yt}/${i}_${r}.png
        "
    ...
    ${"common"!==n?V`
          <picture class="card__rarityLayer">
            <source
              srcset="
              ${Tt}/border-layers/gems/${yt}/rarity_${n}.webp ${yt}w,
                ${Tt}/border-layers/gems/${bt}/rarity_${n}.webp ${bt}w,
                ${Tt}/border-layers/gems/${wt}/rarity_${n}.webp ${wt}w,
                ${Tt}/border-layers/gems/${vt}/rarity_${n}.webp ${vt}w,
                ${Tt}/border-layers/gems/${xt}/rarity_${n}.webp ${xt}w,
                ${Tt}/border-layers/gems/${St}/rarity_${n}.webp ${St}w,
                ${Tt}/border-layers/gems/${Ct}/rarity_${n}.webp ${Ct}w
              "
              sizes="${e}"
              type="image/webp"
            />
            <source
              srcset="
              ${Tt}/border-layers/gems/${yt}/rarity_${n}.png ${yt}w,
                ${Tt}/border-layers/gems/${bt}/rarity_${n}.png ${bt}w,
                ${Tt}/border-layers/gems/${wt}/rarity_${n}.png ${wt}w,
                ${Tt}/border-layers/gems/${vt}/rarity_${n}.png ${vt}w,
                ${Tt}/border-layers/gems/${xt}/rarity_${n}.webp ${xt}w,
                ${Tt}/border-layers/gems/${St}/rarity_${n}.webp ${St}w,
                ${Tt}/border-layers/gems/${Ct}/rarity_${n}.png ${Ct}w
              "
              sizes="${e}"
              type="image/png"
            />
            <img
              srcset="
                ${Tt}/border-layers/gems/${yt}/rarity_${n}.png
              "
    ...
    ${"legendary"===n?V`
          <picture class="card__wreathLayer">
            <source
              srcset="
                ${Tt}/border-layers/wreaths/${yt}/wreath_${r}.webp ${yt}w,
                ${Tt}/border-layers/wreaths/${bt}/wreath_${r}.webp ${bt}w,
                ${Tt}/border-layers/wreaths/${wt}/wreath_${r}.webp ${wt}w,
                ${Tt}/border-layers/wreaths/${vt}/wreath_${r}.webp ${vt}w,
                ${Tt}/border-layers/wreaths/${xt}/wreath_${r}.webp ${xt}w,
                ${Tt}/border-layers/wreaths/${St}/wreath_${r}.webp ${St}w,
                ${Tt}/border-layers/wreaths/${Ct}/wreath_${r}.webp ${Ct}w
              "
              sizes="${e}"
              type="image/webp"
            />
            ...
            <source
              srcset="
              ${Tt}/border-layers/wreaths/${yt}/wreath_${r}.png ${yt}w,
                ${Tt}/border-layers/wreaths/${bt}/wreath_${r}.png ${bt}w,
                ${Tt}/border-layers/wreaths/${wt}/wreath_${r}.png ${wt}w,
                ${Tt}/border-layers/wreaths/${vt}/wreath_${r}.png ${vt}w,
                ${Tt}/border-layers/wreaths/${xt}/wreath_${r}.png ${xt}w,
                ${Tt}/border-layers/wreaths/${St}/wreath_${r}.png ${St}w,
                ${Tt}/border-layers/wreaths/${Ct}/wreath_${r}.png ${Ct}w
              "
              sizes="${e}"
              type="image/png"
            />
            <img
              srcset="
                ${Tt}/border-layers/wreaths/${yt}/wreath_${r}.png
              "
    ...
    ${"core"===o&&"plain"===r?V`
          <picture class="card__lockIconLayer">
            <source
              srcset="
                ${Tt}/border-layers/locks/${kt}/lock_${r}.webp ${kt}w,
                ${Tt}/border-layers/locks/${Pt}/lock_${r}.webp ${Pt}w,
              "
              type="image/webp"
            />
            ...
            <source
              srcset="
                ${Tt}/border-layers/locks/${kt}/lock_${r}.png ${kt}w,
                ${Tt}/border-layers/locks/${Pt}/lock_${r}.png ${Pt}w,
              "
              type="image/png"
            />
            ...
            <img
              srcset="
                ${Tt}/border-layers/locks/lock_${r}.png
              "
    ...
    ${s?V`
          <picture class="card__tribeBarLayer">
            <source
              srcset="
                ${Tt}/border-layers/tribe_bars/${yt}/tribebar_${r}.webp ${yt}w,
                ${Tt}/border-layers/tribe_bars/${bt}/tribebar_${r}.webp ${bt}w,
                ${Tt}/border-layers/tribe_bars/${wt}/tribebar_${r}.webp ${wt}w,
                ${Tt}/border-layers/tribe_bars/${vt}/tribebar_${r}.webp ${vt}w,
              "
              sizes="${e}"
              type="image/webp"
            />
            <source
              srcset="
                ${Tt}/border-layers/tribe_bars/${yt}/tribebar_${r}.png ${yt}w,
                ${Tt}/border-layers/tribe_bars/${bt}/tribebar_${r}.png ${bt}w,
                ${Tt}/border-layers/tribe_bars/${wt}/tribebar_${r}.png ${wt}w,
                ${Tt}/border-layers/tribe_bars/${vt}/tribebar_${r}.png ${vt}w,
              "
              sizes="${e}"
              type="image/png"
            />
            ...
            <img
              srcset="
                ${Tt}/border-layers/tribe_bars/${Ct}/tribebar_${n}.png
              "
  ...
  `))(Object.assign({qualityName:e,responsiveSrcsetSizes:this.responsiveSrcsetSizes},this.protoCardData))}
              ${(({type:e="",name:t="⃠",effect:r="⃠",mana:n="⃠",attack:i="⃠",health:o="⃠",tribe:s="",cardSet:a="",ch:l=0,cw:c=0})=>{e=Et(e);const p=RegExp(/creature|weapon/).test(e),d=t.split("").length>=20,u=Math.floor(.5*l),h=`${0===u?1:u}px`,_="rgba(0, 0, 0, 1)",g=`0 0 ${h} ${_}, 0 0 ${h} ${_}, 0 0 ${h} ${_}`,m=Ze({fontSize:`${10.5*l}px`,top:`${6.85*l}px`,left:`${9.5*c}px`,width:`${19*c}px`,textShadow:g}),$=Ze({fontSize:`${d?3.9*l:4.93*l}px`,bottom:`${32.85*l}px`,height:`${9*l}px`,left:`${13.25*c}px`,right:`${5.3*c}px`,textShadow:g}),f=Ze({fontSize:`${9.5*l}px`,bottom:`${4.5*l}px`,width:`${15*c}px`,left:`${10.5*c}px`,textShadow:g}),y=Ze({fontSize:`${9.5*l}px`,width:`${16*c}px`,bottom:`${4.6*l}px`,right:`${2.5*c}px`,textShadow:g}),b=Ze({fontSize:`${3.2*l}px`,bottom:`${3.1*l}px`,height:`${4.82*l}px`,left:`${30.5*c}px`,right:`${23*c}px`,textShadow:g}),w=Ze({fontSize:`${6*l}px`,top:`${10*l}px`,right:`${9*c}px`});return V`
  ...
  `})(Object.assign({ch:this.ch,cw:this.cw},this.protoCardData,{cardSet:this.protoCardData.set}))}
    ...
    `}};zt([se({type:Number})],At.prototype,"protoId",void 0),zt([se({type:Number})],At.prototype,"quality",void 0),zt([se({type:Object})],At.prototype,"inputProtoData",void 0),zt([se({type:String})],At.prototype,"responsiveSrcsetSizes",void 0),zt([se({type:Boolean})],At.prototype,"useLegacyQualityMapping",void 0),At=zt([ne("composited-card")],At);const Lt=pe`
  font-family: 'Unchained', serif;
  line-height: 1.1;
`,Mt=pe`
  font-family: 'Open Sans', sans-serif;
  line-height: 1.5;
`,jt=pe`black`,It=pe`white`,Ut=pe`#f9f9f9`,Vt=(pe`#f1f1f1`,pe`65px`),Dt=pe`100px`,Bt=pe`#282828`,Wt=pe`#333`,Ft=pe`rgba(255,255,255,0.15)`,Ht=[pe`#8295A2`,pe`#8295A2`,pe`#6A8B35`,pe`#3D91B9`,pe`#84343E`,pe`#B461C5`,pe`#E5D93C`,pe`#94E6FB`,pe`white`],Qt=pe`#9f78dd`,Jt=(e=0)=>pe`
  width: 100%;
  cursor: pointer;
  background: ${Bt};
  border: 2px solid ${Ft};
...
`;var Gt=function(e,t,r,n){var i,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,n);else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(s=(o<3?i(s):o>3?i(t,r,s):i(t,r))||s);return o>3&&s&&Object.defineProperty(t,r,s),s};let Yt=class extends ue{constructor(){super(),this.currentProtoId=Math.floor(99*Math.random()+1),this.currentQuality=Math.floor(4*Math.random()+1),this.currentQualityInWords=qt[this.currentQuality-1];const e=this.getUrlParams(),t=e.get("protoid"),r=e.get("quality");null!==t&&(this.currentProtoId=parseInt(t,10)),null!==r&&(this.currentQuality=parseInt(r,10),this.currentQualityInWords=qt[this.currentQuality-1]),null!==t&&null!==r&&this.updatePageImageMetadata(),fetch("https://dev.godsunchained.com/proto?format=flat").then(e=>e.json()).then(e=>{this.protosCollection=e,this.currentProtoData=Object.assign({},e[this.currentProtoId],{id:this.currentProtoId}),this.updatePageMetadata()}).catch(e=>console.error(e))}static get styles(){return(()=>pe`
  @keyframes floatCard {
    from {
  ...
  *:after {
  ...
  .appContainer__controls__title {
    ...
    margin: 0;
    text-shadow: 0 1px 0 ${Wt}, 1px 0 0 ${Wt},
      1px 1px 0 ${Wt}, -1px 0 0 ${Wt},
      -1px -1px 0 ${Wt}, 0 -1px 0 ${Wt};
  }
...
`)()}updated(e){void 0===e.get("currentProtoId")&&void 0===e.get("currentQuality")||(this.updateUrlParams(),this.updatePageMetadata())}updatePageMetadata(){document.querySelector('meta[property="og:title"]').setAttribute("content",this.currentProtoData.name),document.querySelector('meta[property="og:description"]').setAttribute("content",this.currentProtoData.effect),document.querySelector('meta[property="og:url"]').setAttribute("content",location.href),this.updatePageImageMetadata()}get currentImageUrl(){return`https://card.godsunchained.com?id=${this.currentProtoId}&q=${this.currentQuality}&w=`}updatePageImageMetadata(){document.querySelector('meta[property="og:image"]').setAttribute("content",`${this.currentImageUrl}256`)}getUrlParams(){return new URLSearchParams(window.location.search)}updateUrlParams(){const e=this.getUrlParams();e.set("protoid",`${this.currentProtoId}`),e.set("quality",`${this.currentQuality}`),window.history.pushState({},"",decodeURIComponent(`${location.pathname}?${e}`))}getScreenShot(e){e.preventDefault(),window.open()}render(){return V`
        ...
        <footer class="appContainer__controls">
          ...
          >
            ...
            <input
              ...
              @change=${e=>{this.currentQuality=e.target.value,this.currentQualityInWords=qt[this.currentQuality-1]}}
            />
          </div>
        </footer>
    ...
    `}};Gt([se()],Yt.prototype,"currentProtoId",void 0),Gt([se()],Yt.prototype,"currentQuality",void 0),Gt([se()],Yt.prototype,"currentQualityInWords",void 0),Gt([se()],Yt.prototype,"currentProtoData",void 0),Gt([se()],Yt.prototype,"protosCollection",void 0),Yt=Gt([ne("demo-app")],Yt);r(8);const Kt=document.createElement("style");Kt.innerHTML=lt().cssText.replace(":host",".compositedCardDomRender"),document.head.appendChild(Kt)}]);
//# sourceMappingURL=bundle.6e89c3b308d9bb3a0baa.js.map