...
},{"lit-element":"+bhx","lit-html/directives/style-map":"3QXw","lit-html/directives/unsafe-html":"/jTP"}],"XEZO":[function(require,module,exports) {
...
"use strict";var t=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(exports,"__esModule",{value:!0});const e=require("lit-element"),i=t(require("@juggle/resize-observer")),s=require("./templating"),o=require("./styles"),a=["plain","plain","bronze","iron","meteorite","shadow","gold","diamond","mythic"],r=new i.default(t=>{t.forEach(t=>t.target.handleResize(t))}),n=()=>{const t=document.createElement("link");t.rel="stylesheet",t.type="text/css",t.href="/src/assets/fonts.css",document.head.appendChild(t)};class h extends e.LitElement{static get properties(){return{protoId:{type:Number},inputProtoData:{type:Object},useHiResAssets:{type:Boolean},resolutionSettings:{lowDpi:Number,highDpi:Number},quality:Number}}static get styles(){return o.getStyles()}constructor(){super(),this.resolutionSettings={lowDpi:"256",highDpi:"512"},this.ch=.01*this.offsetHeight,this.cw=.01*this.offsetWidth,n()}connectedCallback(){super.connectedCallback(),r.observe(this),this.getViewProtoData()}disconnectedCallback(){super.disconnectedCallback(),r.unobserve(this)}fetchProtoData(){return this.loading=!0,fetch(`//api.godsunchained.com/v0/proto/${this.protoId}`).then(t=>t.json())}handleResize(t){this.ch=.01*t.borderBoxSize.blockSize,this.cw=.01*t.borderBoxSize.inlineSize,this.requestUpdate()}getViewProtoData(){this.useHiResAssets&&(this.resolutionSettings={lowDpi:"512",highDpi:"1024"}),this.qualityName=a[this.quality],this.protoId?this.getProtoDataFromApi():this.inputProtoData&&this.getProtoDataFromInput()}getProtoDataFromApi(){return this.fetchProtoData().then(t=>{const{id:e,type:i,attack:s,health:o,effect:a,name:r,rarity:n,god:h}=t;return this.protoCardData={id:e,type:i,attack:s.Int64,health:o.Int64,effect:a,name:r,rarity:n,god:h},this.loading=!1,this.requestUpdate(),t})}getProtoDataFromInput(){this.protoCardData=Object.assign({},this.inputProtoData),this.protoId=this.inputProtoData.id,this.loading=!1}render(){const t="mythic"===this.qualityName;return e.html`
      ${this.loading?s.loadingTemplate():e.html`
          ...
          `}
    `}}customElements.define("composited-card",h);
},{"lit-element":"+bhx","@juggle/resize-observer":"LQJF","./templating":"iMSu","./styles":"XEZO"}]},{},["zNll"], null)
//# sourceMappingURL=/composited-card.js.map